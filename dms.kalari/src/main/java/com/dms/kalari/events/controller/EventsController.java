...
public class EventsController extends BaseController<EventDTO, EventService> {
    ...
    public String listEvents(@RequestParam(defaultValue = "0") int page, 
        ...
        logInfo("Event Page - Total Elements: {}, Total Pages: {}", 
    ...
    public String listEventsByNode(@PathVariable(value = "id", required = false) Long nodeId,  
        ...
        logInfo("Node Type: {}, User Node Type: {}, Selected Node: {}", 
                nodeType.getLevel(), userNodeType.getLevel(), nodeId);
    ...
    public ResponseEntity<Map<String, Object>> addEvent(@PathVariable(value = "id") Long mNodeId,
        ...
        if ((seniorItemIds == null || seniorItemIds.isEmpty()) && 
            ...
            result.rejectValue("eventItems", "error.event",
                    "Please select at least one item from catogories");
        }
        ...
        return handleRequest(result, () -> {
            ...
            if (subjuniorItemIds != null && !subjuniorItemIds.isEmpty()) {
                eventItemMapService.saveMappings(savedEvent.getEventId(), subjuniorItemIds, EventItemMap.Category.SUBJUNIOR);
            }
    ...
    public String editEventForm(@PathVariable Long id, Model model, Authentication authentication) {
        ...
        Map<EventItemMap.Category, List<Long>> selectedItems = 
            eventItemMapService.findItemsByEventIdGroupedByCategory(eventId);
